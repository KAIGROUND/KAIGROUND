        ...
        >
            ...
            <div v-for="(i, idx) in this.node" :key="idx" @mouseover="mouseover(idx)" @mouseleave="mouseleave" @mousemove="mousemove">
                <v-btn style="position: relative"
                       elevation="2"
                       fab
                       :color="i.cur_team.includes($store.state.class) ? 'pink' : 'indigo'"
                       class="fab-small"
    ...
    export default {
        ...
        data(){
            return({
                ...
                name: ["아름관","소망관","사랑관","지혜관","신뢰관","진리관","성실관","카이마루","우체국","교양분관","산업디자인학과동","인문사회과학부동","대강당","정문술빌딩","스포츠컴플렉스","장영신학생회관","태울관","기계공학동","노천극장","풍동실험동","미르나래관","인터내셔널빌리지","희망관","어은동산","W8","KARA","KAIST본관","창의학습관","궁리실험관","자연과학동","의과학연구센터","세종관","파팔라도","운동장","나노종합기술원","정보전자공학동","KI빌딩","산업경영학동","교직원회관","학술문화관","오리연못","지오센트리퓨지실험동"],
                node:[],
                switch1:false,
                hover:0,
                last_hovered:[0,0],
