<template>
  <v-app>
        ...
        <v-row no-gutters dense>
          ...
          <v-col cols="6">
            <v-card v-if="turn >= 8" class="mt-2 pa-4">
              <div>[특별상] <b>다리 아프겠다...</b>: 시작부터 게임이 끝날 때까지 이동한 거리가 가장 긴 팀이 수상!</div>
              <div>[특별상] <b>21학번 환영해요</b>: 21등 팀에게 수상!</div>
            </v-card>
          </v-col>
          <v-col cols="3">
            <Header/>
    ...
    >
      <v-card>
        <div class="game-progressing">특별상 2개가 공개됩니다!</div>
        <div class="game-progressing-sub">[특별상] <b>다리 아프겠다...</b>: 시작부터 게임이 끝날 때까지 이동한 거리가 가장 긴 팀이 수상!</div>
        <div class="game-progressing-sub">[특별상] <b>21학번 환영해요</b>: 21등 팀에게 수상!</div>
      </v-card>
    </v-dialog>
